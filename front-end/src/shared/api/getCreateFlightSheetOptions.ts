...
const ResponseRuntype = rt.Record({
  ...
  algorithmMiner: rt.Array(rt.Record({
    id: rt.Number,
    algorithmId: rt.Number,
    minerId: rt.Number
  }))
...
export const getCreateFlightSheetOptions = makeApiFunc<Request, typeof ResponseRuntype>("GET", 'other-data/get-create-flight-sheet-options', ResponseRuntype)
